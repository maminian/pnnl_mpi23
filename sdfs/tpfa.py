...
class TPFA(object):
    ...
    def __init__(self, geom, bc):
        ...
        self.cell_hfs = np.argsort(self.geom.cells.to_hf).reshape(-1, 4)
    ...
    def sens(self):
        ...
        cell_Tgf_sens = Tgf_sens_interior[self.cell_ihfs]
        return (cell_Tgf_sens.sum(axis=1) + self.alpha_dirichlet), cell_Tgf_sens, self.cell_neighbors, self.rhs_dirichlet